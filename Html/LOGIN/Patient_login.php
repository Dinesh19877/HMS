...
$_SESSION['regitserid'] = $row['id'];

    $_SESSION['username'] = $row['name'];
    $_SESSION['email1'] = $row['email'];
    $_SESSION['password1'] = $row['password'];
    $_SESSION['pnumber1'] = $row['pnumber'];

    header('Location:../../Html/patient/patient_dashboard.php');
...
<!-- <span class="error_msg">Incorrect email or password</span> -->
    ...
    <div class="form_con btn" >
<p class="account account11">Don't have an account ? <a href="../../Html/registration/registration1.php">Register</a></p>    </div>
  </form>
</body>
