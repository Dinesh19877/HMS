...
<body>
  ...
  <!-- ======form ======= -->
  <form action="../../php/Register/registration.php" method="post" name="FORM" onsubmit="return validform()" id="form" class="form" autocomplete="on">
    ...
    <div class="form_con btn" >
      <input type="submit" name="sumb" id="submit" class="button-1" value="Register" placeholder="" />
    </div>

    <div class="form_con btn" >
<p class="account">Already have an account ? <a href="../../Html/LOGIN/admin.html">Log in</a></p>    </div>
  </form>
</body>
