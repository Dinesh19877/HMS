...
if (isset($_GET['search_name'])) {
    ...
    $query = "SELECT * FROM subcategories WHERE name LIKE '%$search_name%'";
}
...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    ?>
    <td> <a href="del_doctor1.php?id=<?php echo $row['id'];?>">Delete</a></td>";
    <td> <a href="doc_update.php?id=<?php echo $row['id'];?>">Update</a></td>";
<?php
    echo "</tr>";
}
